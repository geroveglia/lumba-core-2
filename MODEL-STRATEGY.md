...
| `claude-opus-4` | 200k | 💰💰💰💰 Premium+ | `opus` |
...
| **Arquitectura** | `pro` | Decisiones de diseño, ADRs |
| ⚡ **Modelado de datos** | `opus` | Diseño de base de datos, modelo ER, migraciones — SIEMPRE Opus |
...
3. ⚡ **No negociable con Opus:** Diseño de base de datos. El `data-architect` corre con Opus siempre. Es el cimiento del sistema — no se escatima en el cimiento.
4. **Costo acumulado:** Monitorear que el costo total por proyecto no exceda lo estimado.
